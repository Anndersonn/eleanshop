...
function Navigation() {
    ...
    return (
        <>
            <Navbar expand="true" className={!burger ? "color__switch" : ""}>
                ...
                <Nav className="nav__wrp w-100 d-none d-lg-flex">
                    <Nav.Link className="navigation__links" href="#features">Features</Nav.Link>
                    <Nav.Link className="navigation__links" href="#pricing">Pricing</Nav.Link>
                    <Nav.Link className="navigation__links" href="#features">Features</Nav.Link>
                    <Nav.Link className="navigation__links" href="#pricing">Pricing</Nav.Link>
                    <Nav.Link className="navigation__links" href="#pricing">Pricing</Nav.Link>
                    <Nav.Link className="navigation__links" href="#features">Features</Nav.Link>
